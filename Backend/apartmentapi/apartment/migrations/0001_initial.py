    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_date', models.DateTimeField(auto_now_add=True, null=True)),
                ('updated_date', models.DateTimeField(auto_now=True, null=True)),
                ('tittle', models.CharField(max_length=30, primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            name='Manager',
            fields=[
                ('user_infor', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, serialize=False, to=settings.AUTH_USER_MODEL)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.BooleanField(default=False)),
                ('apartment', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, related_name='apartment', serialize=False, to='apartment.apartment')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('monthlyfee_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, to='apartment.monthlyfee')),
                ('reservation_name', models.CharField(default='Đăng ký giữ xe', max_length=30, primary_key=True, serialize=False)),
                ...
                ('vehicle', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='reservation_vehicles', to='apartment.vehicle')),
            ],
            options={
                'abstract': False,
            },
